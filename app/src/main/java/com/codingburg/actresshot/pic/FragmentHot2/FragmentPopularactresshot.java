...
public class FragmentPopularactresshot extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        InterstitialAd.load(getContext(),view.getContext().getString(R.string.admob_interstitial_unit_id), adRequest, new InterstitialAdLoadCallback() {
            @Override
    ...
    private void firstLoadData() {
        ...
        if (tool.isNetworkAvailable()) {
            ...
            dataBaseHelp.deleteData(Const.TABLE_POPULAR);

            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Const.URL_POPULAR_WALLPAPER + 0, null, new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            dataBaseHelp.saveWallpaper(arrayList.get(i), Const.TABLE_POPULAR);
            ...
            arrayList = dataBaseHelp.getPopular(Const.TABLE_POPULAR);
            mAdapter = new AdapterWallpaperactresshot(getActivity(), arrayList);
            recyclerView.setAdapter(mAdapter);
        }
    ...
    private void loadMore() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Const.URL_POPULAR_WALLPAPER + lastId, null, new Response.Listener<JSONArray>() {
            @Override
