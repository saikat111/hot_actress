...
public class FragmentRandom extends Fragment {
    ...
    private void firstLoadData() {
        ...
        if (tool.isNetworkAvailable()) {
            ...
            dataBaseHelp.deleteData(Const.TABLE_RANDOM);

            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Const.URL_RANDOM_WALLPAPER + 0, null, new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            dataBaseHelp.saveWallpaper(arrayList.get(i), Const.TABLE_RANDOM);
            ...
            showRefresh(false);
            arrayList = dataBaseHelp.getRandom(Const.TABLE_RANDOM);
            mAdapter = new AdapterWallpaperactresshot(getActivity(), arrayList);
            recyclerView.setAdapter(mAdapter);
        }
    ...
    private void loadMore() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Const.URL_RANDOM_WALLPAPER + lastId, null, new Response.Listener<JSONArray>() {
            @Override
    ...
    private void LoadInterstitialAd() {
        ...
        interstitialAd = new com.facebook.ads.InterstitialAd(view.getContext(), view.getContext().getString(R.string.facebook_interstitial_ads));
