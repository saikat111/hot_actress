...
public class FragmentFeaturedactresshot extends Fragment {
    ...
    private void firstLoadData() {
        ...
        if (tool.isNetworkAvailable()) {
            ...
            dataBaseHelp.deleteData(Const.TABLE_FEATURED);

            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Const.URL_FEATURED_WALLPAPER + 0, null, new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            dataBaseHelp.saveWallpaper(arrayList.get(i), Const.TABLE_FEATURED);
            ...
            showRefresh(false);
            arrayList = dataBaseHelp.getFeatured(Const.TABLE_FEATURED);
            mAdapter = new AdapterWallpaperactresshot(getActivity(), arrayList);
            recyclerView.setAdapter(mAdapter);
        }
    ...
    private void loadMore() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, Const.URL_FEATURED_WALLPAPER + lastId, null, new Response.Listener<JSONArray>() {
            @Override
